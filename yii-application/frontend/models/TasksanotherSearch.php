...
use app\models\Tasksanother;

/**
 * TasksanotherSearch represents the model behind the search form of `app\models\Tasksanother`.
 */
class TasksanotherSearch extends Tasksanother
{
    /**
     * {@inheritdoc}
     */
